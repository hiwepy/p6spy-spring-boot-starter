...
import com.p6spy.engine.spy.P6ConnectionPoolDataSource;
...
public class P6SpyAutoConfiguration {
	...
	public P6DataSource druidDataSource(@P6spyDataSource ObjectProvider<DataSource> p6spyDataSource,
		...
		P6ConnectionPoolDataSource p = new P6ConnectionPoolDataSource();
		p.setJdbcEventListenerFactory(jdbcEventListenerFactory);
